  ...
  return ( <>
    ...
    <form className="flex flex-col gap-4 w-2/4" onSubmit={handleSubmit}>
      ...
      value={data.price}
       ...
       <input type="submit" value="Add Product" className="p-1 outline-none border-2 border-orange-500 rounded-lg w-1/3 bg-orange-400 text-white hover:bg-orange-600"  />  
    </form>
    </div>
  </>)
}
